...
struct CreateCommand: ParsableCommand {
    ...
    func run() throws {
        ...
        if edit || !template {
            ...
            print("Edit with: agentctl edit \(name)")
        }
    }
